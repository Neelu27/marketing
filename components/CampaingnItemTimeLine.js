...
export default class CampaingnItemTimeLine extends Component {
      constructor(props){
          super(props);
          this.state={
              isHorizontal:true,
    ...
    getCampaignData=async()=>{
          ...
          console.log(SERVER_URL,'rrrrrrrrrr');
            await fetch(SERVER_URL+'/api/marketing/campaignLogs/?contact='+7,{
              ...
              console.log(json,'CampaignItemExp');
                this.setState({ CampaignItemExp: json,});
                console.log(this.state.CampaignItemExp,"this.state.CampaignItemExp")
            })
       }
  ...
  render(){
    ...
    return(
        <View style={{ flex: 1,backgroundColor:'#d4e2f0',marginBottom:50}}>
            <FlatList
                data={this.state.CampaignItemExp}
